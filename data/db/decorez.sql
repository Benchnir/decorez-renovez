...
--
-- Client: localhost
-- Généré le : Lun 16 Juillet 2012 à 20:38
...
(7, 1, 1, 2, 0, 'Ã‰crire des aides personnalisÃ©es est facile, vous devez juste suivre ces rÃ¨gles :\r\n\r\nBien qu''il ne soit pas strictement nÃ©cessaire, il est recommandÃ© soit d''implÃ©menter Zend_View_Helper_Interface ou d''Ã©tendre Zend_View_Helper_Abstract quand vous crÃ©ez vos aides. Introduit en 1.6.0, ceux-ci dÃ©finissent la mÃ©thode setView() ; cependant, dans les prochaines releases, nous prÃ©voyons d''implÃ©menter un motif de conception StratÃ©gie qui permettra de simplifier en grande partie le schÃ©ma de nomination dÃ©taillÃ© ci-dessous. Contruire sur ces bases Ã  partir de maintenant vous aidera pour vos codes futurs.\r\n\r\nLe nom de la classe doit, au minimum, se terminer avec le nom de l''aide en utilisant une notation en casseMÃ©langÃ©e. Par exemple, si vous Ã©crivez une aide appelÃ©e "actionSpeciale", le nom de la classe doit Ãªtre au minimum "ActionSpeciale". Vous devriez donner au nom de la classe un prÃ©fixe, et il est recommandÃ© d''utiliser "Ma_View_Helper" comme partie de ce prÃ©fixe : "Ma', '', '2012-03-30 18:45:47', '2012-07-09 14:16:02', 12),
...
INSERT INTO `member` (`id`, `lastname`, `firstname`, `email`, `password`, `phone`, `fax`, `isProfessionnal`, `siretOrSiren`, `company`, `creationDate`, `updateDate`, `role`) VALUES
(1, 'Frappat', 'Maxime', 'test@gmail.com', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', '245453646', '', 1, NULL, 'LordCorporation', '2012-03-30 18:20:40', '2012-05-07 23:17:32', 0),
(2, 'Bench', 'Mounir', 'test2@gmail.com', '109f4b3c50d7b0df729d299bc6f8e9ef9066971f', '54561653', '', 0, NULL, NULL, '2012-05-08 12:32:22', '2012-05-08 12:32:22', 0),
...
INSERT INTO `service` (`id`, `member_id`, `mainPicture`, `isPartner`, `creationDate`, `updateDate`, `mainJob_id`, `description`, `experience`) VALUES
(1, 1, '', 0, '2012-05-08 09:20:11', '2012-05-27 17:06:49', 1, 'dgdr regrt rthertrthreth', 15),
